...
SimpleForm.setup do |config|
  ...
  config.error_notification_class = "alert alert-important alert-danger alert-dismissible"
  ...
  config.wrappers :vertical_boolean, tag: "fieldset", class: "mb-3" do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :form_check_wrapper, class: "form-check d-flex align-items-center gap-2" do |bb|
  ...
  config.wrappers :vertical_boolean_switch, tag: "fieldset", class: "form-group" do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :form_check_wrapper, tag: "div", class: "form-check form-switch" do |bb|
      bb.use :input, class: "form-check-input", error_class: "is-invalid"
      bb.use :label, class: "form-check-label form-label"
      bb.use :full_error, wrap_with: { tag: "div", class: "invalid-feedback" }
      bb.use :hint, wrap_with: { tag: "small", class: "form-text text-muted" }
    end
  end

  config.wrappers :vertical_switch, tag: "fieldset", class: "form-group" do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: "form-check-label form-label"
    b.wrapper :form_check_wrapper, tag: "div", class: "form-check form-switch" do |bb|
      bb.use :input, class: "form-check-input", error_class: "is-invalid"
      bb.use :full_error, wrap_with: { tag: "div", class: "invalid-feedback" }
      bb.use :hint, wrap_with: { tag: "small", class: "form-text text-muted" }
  ...
  config.wrappers :input_icon, class: "mb-3", error_class: "is-invalid" do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
    ...
    b.optional :readonly
    b.use :label, class: "form-label"
    b.wrapper :input_icon_tag, tag: "div", class: "input-icon" do |ba|
      ba.optional :prepend, icon_addon: true
      ba.use :input, class: "form-control", error_class: "is-invalid"
      ba.optional :append, icon_addon: true
    end
    b.use :full_error, wrap_with: { class: "invalid-feedback" }
    b.use :hint, wrap_with: { class: "form-text" }
  end
  ...
  config.wrappers :input_group_flat, class: "mb-3" do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
    ...
    b.optional :readonly
    b.use :label, class: "form-label"
    b.wrapper :input_group_tag, class: "input-group input-group-flat" do |ba|
      ba.optional :prepend
      ba.use :input, class: "form-control", error_class: "is-invalid"
      ba.optional :append
      ba.use :full_error, wrap_with: { class: "invalid-feedback" }
